...
DELETE FROM exercizer.subject_document WHERE subject_id IN (SELECT id FROM exercizer.subject WHERE is_library_subject IS TRUE);
DELETE FROM exercizer.subject_scheduled WHERE subject_id IN (SELECT id FROM exercizer.subject WHERE is_library_subject IS TRUE);
