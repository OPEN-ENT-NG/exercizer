directives.push(
    {
        name: 'dashboardArchivesCopyList',
        injections: ['SubjectCopyService', '$location', 'ArchivesService', 'GroupService','DateService','$q', (SubjectCopyService, $location, ArchivesService, GroupService, DateService, $q) => {
            return {
                restrict: 'E',
                scope: {
                    selectedSubjectScheduled : "="
                },
                templateUrl: 'exercizer/public/app/components/dashboard/teacher_dashboard/teacher_dashboard_archive/templates/dashboard-archives-copy-list.html',
                link: (scope:any) => {
