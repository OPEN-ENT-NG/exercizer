directives.push(
    {
        name: 'dashboardArchives',
        injections: [ '$location', '$window', 'DateService', 'ArchivesService', 'SubjectCopyService', ($location, $window, DateService, ArchivesService, SubjectCopyService) => {
            return {
                restrict: 'E',
                scope: {
                ...
                templateUrl: 'exercizer/public/app/components/dashboard/teacher_dashboard/teacher_dashboard_archive/templates/dashboard-archives.html',
                link: (scope:any) => {
                    ...
                    scope.getSubjectScheduledPicture = function (subjectScheduled) {
                        return subjectScheduled.picture || (window as any).skin.basePath + 'img/illustrations/image-default.svg';
                    };
