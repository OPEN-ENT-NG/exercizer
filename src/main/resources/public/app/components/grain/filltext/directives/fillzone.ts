directives.push({
        ...
        injections: [() => {
            return {
                ...
                '<input type="text" ng-if="optionData.mode === \'perform-text\'" ng-model="optionData.zone.answer" complete-change="updateGrainCopy()" />' +
                '<select ng-if="optionData.mode === \'perform-list\'" ng-options="o as o for o in optionData.zone.options" ng-model="optionData.zone.answer" ng-change="updateGrainCopy()"></select>' +
