directives.push(
    {
        name: 'subjectViewCopyTeacherFooter',
        injections: ['$location','SubjectCopyService', ($location, SubjectCopyService) => {
            return {
                ...
                templateUrl: 'exercizer/public/app/components/subject/subject_view_copy/templates/subject-view-copy-teacher-footer.html',
                link:(scope:any) => {
