...
export const subjectViewCopyGrainCopyList = ng.directive('subjectViewCopyGrainCopyList',
    ['$filter', ($filter) => {
        return {
            restrict: 'E',
            scope : {
            ...
            templateUrl: 'exercizer/public/ts/app/components/subject/subject_view_copy/templates/subject-view-copy-grain-copy-list.html',
            link:(scope:any) => {
