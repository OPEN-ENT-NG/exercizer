...
export const folderNavItem = ng.directive('folderNavItem',
    ['FolderService', 'DragService', '$compile', (FolderService, DragService, $compile) => {
        return {
            restrict: 'E',
            replace: true,
            scope: {
            ...
            templateUrl: 'exercizer/public/ts/app/components/folder/common/folder_nav/templates/folder-nav-item.html',
