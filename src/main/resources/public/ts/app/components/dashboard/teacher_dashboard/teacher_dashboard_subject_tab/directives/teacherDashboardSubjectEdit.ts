...
export const teacherDashboardSubjectEdit = ng.directive('teacherDashboardSubjectEdit',
    ['FolderService', 'SubjectService','$location', (FolderService, SubjectService,$location) => {
        return {
            restrict: 'E',
            scope: {},
            templateUrl: 'exercizer/public/ts/app/components/dashboard/teacher_dashboard/teacher_dashboard_subject_tab/templates/teacher-dashboard-subject-edit.html',
            link: (scope:any) => {
