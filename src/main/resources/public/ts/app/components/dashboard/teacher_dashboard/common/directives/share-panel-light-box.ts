...
export const sharePanelModal = ng.directive('sharePanelModal', [() => {
        return {
            restrict: 'E',
            scope: {},
            templateUrl: 'exercizer/public/ts/app/components/dashboard/teacher_dashboard/common/templates/share-panel.html',
